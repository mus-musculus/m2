...
AstValueDiv = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueMod = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueAnd = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueOr  = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueXor = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueEq  = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueNe  = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueLt  = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueGt  = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueLe  = Tagged (left, right : *AstValue, ti : *TokenInfo)
AstValueGe  = Tagged (left, right : *AstValue, ti : *TokenInfo)
...
AstValuePlus   = Tagged (value : *AstValue, ti : *TokenInfo)
AstValueNot    = Tagged (value : *AstValue, ti : *TokenInfo)
