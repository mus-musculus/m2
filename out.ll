...
%StmtIf = type {%Value*, %Stmt*, %union.2, %TokenInfo*}
%StmtWhile = type {%Value*, %Stmt*, %TokenInfo*}
%StmtReturn = type {%union.3, %TokenInfo*}
...
;stmt48:
  ...
  %94 = getelementptr inbounds %AstValueFunc, %AstValueFunc* %93, i1 0, i32 1; loadImmPtr
  %95 = inttoptr i64 0 to%AstStmt*
  store %AstStmt* %95, %AstStmt** %94, align 8
;stmt49:
...
;stmt4:
  ...
  %7 = call i1 (%Str) @need (%Str %6)
;stmt5:
  %8 = call %union.6 (%TokenInfo*) @func250 (%TokenInfo* %5)
;stmt6:
...
;stmt8:
  ...
  %14 = bitcast %union.6 %8 to %AstStmt*
...
;stmt5:
  ...
  %9 = getelementptr inbounds %AstValueFunc, %AstValueFunc* %8, i1 0, i32 1; loadImmPtr
  %10 = inttoptr i64 0 to%AstStmt*
  store %AstStmt* %10, %AstStmt** %9, align 8
;stmt6:
  ret %AstValue* %4
}
...
;stmt0:
  %3 = call %Unit* (%Nat32) @malloc (%Nat32 240)
...
;stmt2:
  ...
  %9 = call %Unit* (%Unit*, %Nat8, %Nat32) @memset (%Unit* %8, %Nat8 0, %Nat32 240)
;stmt3:
  %10 = getelementptr inbounds %AstStmt, %AstStmt* %4, i1 0, i32 0
  store %AstStmtKind %0, %AstStmtKind* %10, align 2
;stmt4:
  %11 = getelementptr inbounds %AstStmt, %AstStmt* %4, i1 0, i32 12
  store %TokenInfo* %1, %TokenInfo** %11, align 8
;stmt5:
  ret %AstStmt* %4
}

define %union.6 @parse_stmt_break (%TokenInfo*) {
;stmt0:
  %2 = call %AstStmt* (%AstStmtKind, %TokenInfo*) @ast_stmt_new (%AstStmtKind 10, %TokenInfo* %0)
  %3 = bitcast %AstStmt* %2 to %union.6
  ret %union.6 %3
}

define %union.6 @parse_stmt_continue (%TokenInfo*) {
;stmt0:
...
;stmt9:
  %23 = bitcast %AstStmt* %20 to %union.8
  ret %union.8 %23
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt10:
  ...
  %26 = call %union.6 (%TokenInfo*) @func247 (%TokenInfo* %25)
  ret %union.6 %26
}

define %union.7 @parse_stmt () {
;stmt0:
  %1 = call %Token* () @func190 ()
;stmt1:
  %2 = call %Token* () @nextok ()
...
select_1_0_ok:
  %39 = call %union.6 (%TokenInfo*) @func248 (%TokenInfo* %3)
  br label %select_1_end
select_1_1:
...
select_1_1_ok:
  %43 = call %union.6 (%TokenInfo*) @func250 (%TokenInfo* %3)
  br label %select_1_end
select_1_2:
...
select_1_2_ok:
  %47 = call %union.6 (%TokenInfo*) @func251 (%TokenInfo* %3)
  br label %select_1_end
select_1_3:
...
select_1_3_ok:
  %51 = call %union.6 (%TokenInfo*) @func252 (%TokenInfo* %3)
  br label %select_1_end
select_1_4:
...
select_1_4_ok:
  %55 = call %union.6 (%TokenInfo*) @func253 (%TokenInfo* %3)
  br label %select_1_end
select_1_5:
...
select_1_5_ok:
  %59 = call %union.6 (%TokenInfo*) @parse_stmt_break (%TokenInfo* %3)
  br label %select_1_end
select_1_6:
...
select_1_6_ok:
  %63 = call %union.6 (%TokenInfo*) @parse_stmt_continue (%TokenInfo* %3)
  br label %select_1_end
select_1_7:
...
select_1_7_ok:
  %68 = call %union.6 (%TokenInfo*) @func249 (%TokenInfo* %3)
  br label %select_1_end
select_1_8:
...
select_1_8_ok:
  %72 = call %union.6 (%TokenInfo*) @func254 (%TokenInfo* %3)
  br label %select_1_end
select_1_9:
  %73 = call %union.8 () @func246 ()
  br label %select_1_end
select_1_end:
  %74 = phi %union.6 [ %39, %select_1_0_ok ], [ %43, %select_1_1_ok ], [ %47, %select_1_2_ok ], [ %51, %select_1_3_ok ], [ %55, %select_1_4_ok ], [ %59, %select_1_5_ok ], [ %63, %select_1_6_ok ], [ %68, %select_1_7_ok ], [ %72, %select_1_8_ok ], [ %73, %select_1_9 ]
  ret %union.6 %74
}

define %union.6 @func247 (%TokenInfo*) {
;stmt0:
...
;stmt4:
  ...
  store %AstValue* %10, %AstValue** %9, align 8
;stmt5:
  %11 = bitcast %AstStmt* %5 to %union.6
  ret %union.6 %11
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt8:
  %16 = bitcast %AstStmt* %13 to %union.6
  ret %union.6 %16
}

define %union.6 @func248 (%TokenInfo*) {
;stmt0:
  %2 = call %Token* () @func190 ()
...
then_0:
;stmt5:
  %13 = inttoptr %Unit zeroinitializer to %union.6
  ret %union.6 %13
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt9:
  %20 = bitcast %AstStmt* %15 to %union.6
  ret %union.6 %20
}

define %union.6 @func249 (%TokenInfo*) {
;stmt0:
  %2 = call %Token* () @func190 ()
  %3 = getelementptr inbounds %Token, %Token* %2, i1 0, i32 1
;stmt1:
...
define %union.6 @func250 (%TokenInfo*) {
;stmt0:
...
endif_1:
;stmt9:
  %14 = call %union.7 () @parse_stmt ()
;stmt10:
  %15 = bitcast %Int64 0 to %Int64
  %16 = ptrtoint %union.7 %14 to %Int64
...
;stmt12:
  ...
  %22 = bitcast %union.7 %14 to %AstStmt*
...
break_0:
;stmt13:
  %25 = bitcast %AstStmt* %2 to %union.6
  ret %union.6 %25
}

define %union.6 @func251 (%TokenInfo*) {
;stmt0:
  %2 = call %AstValue* () @func221 ()
;stmt1:
...
;stmt4:
  %9 = call %union.6 (%TokenInfo*) @func250 (%TokenInfo* %6)
;stmt5:
  %10 = alloca %union.9
  %11 = inttoptr %Unit zeroinitializer to %union.9
  store %union.9 %11, %union.9* %10, align 16
;stmt6:
...
then_1:
;stmt10:
  %20 = call %union.6 (%TokenInfo*) @func251 (%TokenInfo* %17)
  store %union.6 %20, %union.6* %10, align 16
  br label %endif_1
else_1:
;stmt11:
...
;stmt12:
  %23 = call %union.6 (%TokenInfo*) @func250 (%TokenInfo* %17)
  store %union.6 %23, %union.6* %10, align 16
  br label %endif_1
endif_1:
  br label %endif_0
else_0:
...
then_2:
;stmt14:
  %26 = inttoptr %Unit zeroinitializer to %union.6
  ret %union.6 %26
  br label %endif_2
else_2:
  br label %endif_2
...
;stmt15:
  ...
  %29 = ptrtoint %union.6 %9 to %Int64
...
;stmt19:
  ...
  %38 = bitcast %union.6 %9 to %AstStmt*
...
;stmt20:
  ...
  %41 = load %union.9, %union.9* %10
  store %union.9 %41, %union.9* %40, align 16
;stmt21:
  %42 = bitcast %AstStmt* %33 to %union.6
  ret %union.6 %42
}

define %union.6 @func252 (%TokenInfo*) {
;stmt0:
  %2 = call %AstValue* () @func221 ()
;stmt1:
...
then_0:
;stmt6:
  %12 = inttoptr %Unit zeroinitializer to %union.6
  ret %union.6 %12
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt7:
  ...
  %15 = ptrtoint %union.6 %9 to %Int64
  %16 = icmp eq %Int64 %15, %14
  br i1 %16, label %then_1, label %else_1
then_1:
;stmt8:
  %17 = inttoptr %Unit zeroinitializer to %union.6
  ret %union.6 %17
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt11:
  ...
  %24 = bitcast %union.6 %9 to %AstStmt*
  store %AstStmt* %24, %AstStmt** %23, align 8
;stmt12:
  %25 = bitcast %AstStmt* %19 to %union.6
  ret %union.6 %25
}

define %union.6 @func253 (%TokenInfo*) {
;stmt0:
  %2 = call i1 () @func194 ()
  br i1 %2, label %then_0, label %else_0
then_0:
;stmt1:
  ...
  %4 = bitcast %AstStmt* %3 to %union.6
  ret %union.6 %4
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt8:
  %15 = bitcast %AstStmt* %12 to %union.6
  ret %union.6 %15
}

define %union.6 @func254 (%TokenInfo*) {
;stmt0:
...
;stmt2:
  %6 = bitcast %AstStmt* %2 to %union.6
  ret %union.6 %6
}

define %union.6 @func255 (%TokenInfo*) {
;stmt0:
...
;stmt10:
  ...
  %28 = ptrtoint %union.1 %26 to %Int64
...
;stmt10:
  ...
  %27 = load %Nat32, %Nat32* %26
  %28 = add %Nat32 %27, 2
  %29 = call %Nat32 (%Nat32, %Nat32) @align (%Nat32 %28, %Nat32 8)
;stmt11:
  %30 = getelementptr inbounds %Type, %Type* %14, i1 0, i32 2
  store %Nat32 %29, %Nat32* %30, align 4
;stmt12:
  %31 = getelementptr inbounds %Type, %Type* %14, i1 0, i32 3
  store %Nat32 %29, %Nat32* %31, align 4
;stmt13:
  %32 = getelementptr inbounds %Type, %Type* %14, i1 0, i32 12
  %33 = getelementptr inbounds %TypeUnion, %TypeUnion* %32, i1 0, i32 2
  %34 = getelementptr inbounds %func410.type5, %func410.type5* %18, i1 0, i32 1
  %35 = load %Nat32, %Nat32* %34
  store %Nat32 %35, %Nat32* %33, align 4
;stmt14:
  %36 = getelementptr inbounds %List, %List* @unions, i1 0
  %37 = bitcast %Type* %14 to %Unit*
  %38 = call i1 (%List*, %Unit*) @list_append (%List* %36, %Unit* %37)
;stmt15:
  %39 = call i1 (%Type*) @func394 (%Type* %14)
  br i1 %39, label %then_0, label %else_0
then_0:
;stmt16:
  %40 = load %Type*, %Type** @typeFreePtr
;stmt17:
  %41 = getelementptr inbounds %Type, %Type* %14, i1 0, i32 12
  %42 = getelementptr inbounds %TypeUnion, %TypeUnion* %41, i1 0, i32 1
  store %Type* %40, %Type** %42, align 8
  br label %endif_0
else_0:
;stmt18:
  %43 = getelementptr inbounds %Type, %Type* %14, i1 0, i32 12
  %44 = getelementptr inbounds %TypeUnion, %TypeUnion* %43, i1 0, i32 1; loadImmPtr
  %45 = inttoptr i64 0 to%Type*
  store %Type* %45, %Type** %44, align 8
  br label %endif_0
endif_0:
;stmt19:
  ret %Type* %14
...
then_0:
;stmt2:
  %5 = inttoptr %Unit zeroinitializer to %union.10
  ret %union.10 %5
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt3:
  %6 = inttoptr %Unit zeroinitializer to %union.11
  ret %union.11 %6
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt11:
  ...
  %38 = load %AstStmt*, %AstStmt** %37
  %39 = getelementptr inbounds %AstStmt, %AstStmt* %38, i1 0, i32 12
  %40 = load %TokenInfo*, %TokenInfo** %39
  %41 = call %Value* (%ValueKind, %Type*, %TokenInfo*) @func429 (%ValueKind 4, %Type* %5, %TokenInfo* %40)
;stmt12:
...
;stmt13:
  ...
  %48 = getelementptr inbounds %Block, %Block* %47, i1 0, i32 3
...
select_1_1:
  ...
  %62 = load %Str, %Str* %61
  %63 = bitcast [2 x %Nat8]* @func469_str2 to %Str
  %64 = call %Str (%Str, %Str, %Str) @cat3 (%Str %62, %Str %63, %Str %14)
  br label %select_1_end
select_1_end:
  %65 = phi %Str [ %14, %select_1_0_ok ], [ %64, %select_1_1 ]
...
;stmt18:
  ...
  store %Block* %28, %Block** %67, align 8
;stmt19:
...
;stmt20:
  %70 = getelementptr inbounds %AstValue, %AstValue* %0, i1 0, i32 5
  %71 = getelementptr inbounds %AstValueFunc, %AstValueFunc* %70, i1 0, i32 1
  %72 = load %AstStmt*, %AstStmt** %71
  %73 = call %union.5 (%AstStmt*) @func492 (%AstStmt* %72)
;stmt21:
  %74 = bitcast %Int64 0 to %Int64
  %75 = ptrtoint %union.5 %73 to %Int64
  %76 = icmp eq %Int64 %75, %74
  br i1 %76, label %then_3, label %else_3
then_3:
;stmt22:
  br label %fail
  br label %endif_3
...
endif_3:
;stmt23:
  %78 = bitcast %union.5 %73 to %Stmt*
;stmt24:
  %79 = getelementptr inbounds %Value, %Value* %41, i1 0, i32 4
  %80 = getelementptr inbounds %Assembly, %Assembly* @asm0, i1 0
  %81 = getelementptr inbounds %Stmt, %Stmt* %78, i1 0, i32 2
  %82 = call %Definition* (%Assembly*, %Str, %Type*, %Block*) @func269 (%Assembly* %80, %Str %14, %Type* %5, %Block* %81)
  store %Definition* %82, %Definition** %79, align 8
;stmt25:
...
;stmt29:
  ...
  %86 = call %Value* (%TokenInfo*) @value_new_poison (%TokenInfo* %85)
  ret %Value* %86
}
...
define %union.5 @func492 (%AstStmt*) {
;stmt0:
...
select_1_0:
  ...
  br i1 %4, label %select_1_0_ok, label %select_1_1
select_1_0_ok:
  %5 = call %union.5 (%AstStmt*) @func493 (%AstStmt* %0)
  br label %select_1_end
select_1_1:
  %6 = icmp eq %AstStmtKind %3, 1
  br i1 %6, label %select_1_1_ok, label %select_1_2
select_1_1_ok:
  %7 = call %union.5 (%AstStmt*) @func494 (%AstStmt* %0)
  br label %select_1_end
select_1_2:
  %8 = icmp eq %AstStmtKind %3, 6
  br i1 %8, label %select_1_2_ok, label %select_1_3
select_1_2_ok:
  %9 = call %union.5 (%AstStmt*) @func496 (%AstStmt* %0)
  br label %select_1_end
select_1_3:
  %10 = icmp eq %AstStmtKind %3, 4
  br i1 %10, label %select_1_3_ok, label %select_1_4
select_1_3_ok:
  %11 = call %union.5 (%AstStmt*) @func498 (%AstStmt* %0)
  br label %select_1_end
select_1_4:
  %12 = icmp eq %AstStmtKind %3, 7
  br i1 %12, label %select_1_4_ok, label %select_1_5
select_1_4_ok:
  %13 = call %union.5 (%AstStmt*) @func499 (%AstStmt* %0)
  br label %select_1_end
select_1_5:
  %14 = icmp eq %AstStmtKind %3, 8
  br i1 %14, label %select_1_5_ok, label %select_1_6
select_1_5_ok:
  %15 = call %union.5 (%AstStmt*) @func500 (%AstStmt* %0)
  br label %select_1_end
select_1_6:
  %16 = icmp eq %AstStmtKind %3, 9
  br i1 %16, label %select_1_6_ok, label %select_1_7
select_1_6_ok:
  %17 = call %union.5 (%AstStmt*) @func501 (%AstStmt* %0)
  br label %select_1_end
select_1_7:
  %18 = icmp eq %AstStmtKind %3, 2
  br i1 %18, label %select_1_7_ok, label %select_1_8
select_1_7_ok:
  %19 = call %union.5 (%AstStmt*) @func504 (%AstStmt* %0)
  br label %select_1_end
select_1_8:
  %20 = icmp eq %AstStmtKind %3, 10
  br i1 %20, label %select_1_8_ok, label %select_1_9
select_1_8_ok:
  %21 = call %union.5 (%AstStmt*) @func505 (%AstStmt* %0)
  br label %select_1_end
select_1_9:
  %22 = icmp eq %AstStmtKind %3, 11
  br i1 %22, label %select_1_9_ok, label %select_1_10
select_1_9_ok:
  %23 = call %union.5 (%AstStmt*) @func506 (%AstStmt* %0)
  br label %select_1_end
select_1_10:
  %24 = icmp eq %AstStmtKind %3, 12
  br i1 %24, label %select_1_10_ok, label %select_1_11
select_1_10_ok:
  %25 = call %union.5 (%AstStmt*) @func507 (%AstStmt* %0)
  br label %select_1_end
select_1_11:
  %26 = icmp eq %AstStmtKind %3, 13
  br i1 %26, label %select_1_11_ok, label %select_1_12
select_1_11_ok:
  %27 = call %union.5 (%AstStmt*) @func508 (%AstStmt* %0)
  br label %select_1_end
select_1_12:
  %28 = inttoptr %Unit zeroinitializer to %union.5
  br label %select_1_end
select_1_end:
  %29 = phi %union.5 [ %5, %select_1_0_ok ], [ %7, %select_1_1_ok ], [ %9, %select_1_2_ok ], [ %11, %select_1_3_ok ], [ %13, %select_1_4_ok ], [ %15, %select_1_5_ok ], [ %17, %select_1_6_ok ], [ %19, %select_1_7_ok ], [ %21, %select_1_8_ok ], [ %23, %select_1_9_ok ], [ %25, %select_1_10_ok ], [ %27, %select_1_11_ok ], [ %28, %select_1_12 ]
  ret %union.5 %29
}

define %union.5 @func493 (%AstStmt*) {
;stmt0:
...
then_0:
;stmt2:
  %9 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %9
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt7:
  %31 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %31
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt9:
  ...
  %35 = getelementptr inbounds %AstStmt, %AstStmt* %0, i1 0, i32 12
  %36 = load %TokenInfo*, %TokenInfo** %35
  call void (%Str, %TokenInfo*) @error (%Str %34, %TokenInfo* %36)
;stmt10:
  %37 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %37
  br label %endif_2
else_2:
  br label %endif_2
endif_2:
;stmt11:
  %39 = getelementptr inbounds %AstValue, %AstValue* %13, i1 0, i32 0
  %40 = load %AstValueKind, %AstValueKind* %39
  %41 = icmp ne %AstValueKind %40, 30
  %42 = getelementptr inbounds %AstValue, %AstValue* %13, i1 0, i32 0
  %43 = load %AstValueKind, %AstValueKind* %42
  %44 = icmp ne %AstValueKind %43, 29
  %45 = getelementptr inbounds %AstValue, %AstValue* %13, i1 0, i32 0
  %46 = load %AstValueKind, %AstValueKind* %45
  %47 = icmp ne %AstValueKind %46, 8
  %48 = and i1 %44, %47
  %49 = and i1 %41, %48
  br i1 %49, label %then_3, label %else_3
then_3:
...
endif_3:
;stmt12:
  %50 = getelementptr inbounds %Value, %Value* %25, i1 0, i32 1
  %51 = load %Type*, %Type** %50
  %52 = getelementptr inbounds %Type, %Type* %51, i1 0, i32 0
  %53 = load %TypeKind, %TypeKind* %52
  br label %select_2_0
select_2_0:
  %54 = icmp eq %TypeKind %53, 5
  br i1 %54, label %select_2_0_ok, label %select_2_1
select_2_0_ok:
  %55 = getelementptr inbounds %Value, %Value* %25, i1 0, i32 1
  %56 = load %Type*, %Type** %55
  %57 = getelementptr inbounds %Type, %Type* %56, i1 0, i32 11
  %58 = getelementptr inbounds %TypeVar, %TypeVar* %57, i1 0, i32 0
  %59 = load %Type*, %Type** %58
  br label %select_2_end
select_2_1:
  %60 = getelementptr inbounds %Value, %Value* %25, i1 0, i32 1
  %61 = load %Type*, %Type** %60
  br label %select_2_end
select_2_end:
  %62 = phi %Type* [ %59, %select_2_0_ok ], [ %61, %select_2_1 ]
;stmt13:
  %63 = call %Value* (%Value*, %Type*) @func481 (%Value* %5, %Type* %62)
;stmt14:
  %64 = getelementptr inbounds %Value, %Value* %63, i1 0, i32 1
  %65 = load %Type*, %Type** %64
  %66 = getelementptr inbounds %AstStmt, %AstStmt* %0, i1 0, i32 12
  %67 = load %TokenInfo*, %TokenInfo** %66
  %68 = call i1 (%Type*, %Type*, %TokenInfo*) @type_check (%Type* %62, %Type* %65, %TokenInfo* %67)
  %69 = xor i1 %68, 1
  br i1 %69, label %then_4, label %else_4
then_4:
;stmt15:
  %70 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %70
  br label %endif_4
else_4:
  br label %endif_4
...
;stmt16:
  ...
  %74 = call %Stmt* (%Value*, %Value*, %TokenInfo*) @func491 (%Value* %25, %Value* %63, %TokenInfo* %73)
  %75 = bitcast %Stmt* %74 to %union.5
  ret %union.5 %75
}

define %union.5 @func494 (%AstStmt*) {
;stmt0:
...
;stmt5:
  ...
  %24 = load %TokenInfo*, %TokenInfo** %23
  %25 = call %Value* (%ValueKind, %Type*, %TokenInfo*) @func429 (%ValueKind 7, %Type* %22, %TokenInfo* %24)
;stmt6:
...
;stmt7:
  ...
  %29 = load %TokenInfo*, %TokenInfo** %28
  %30 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 1, %TokenInfo* %29)
;stmt8:
...
;stmt12:
  %43 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %43
}
...
;stmt1:
  %6 = call %union.5 (%AstStmt*) @func492 (%AstStmt* %5)
;stmt2:
  %7 = bitcast %Int64 0 to %Int64
  %8 = ptrtoint %union.5 %6 to %Int64
  %9 = icmp eq %Int64 %8, %7
  br i1 %9, label %then_0, label %else_0
then_0:
;stmt3:
...
;stmt1:
  ...
  %9 = call %Block* (%Block*, %Block*) @func495 (%Block* %5, %Block* %8)
;stmt2:
  %10 = load %FuncContext*, %FuncContext** @fctx
  %11 = getelementptr inbounds %FuncContext, %FuncContext* %10, i1 0, i32 2
...
;stmt3:
  ...
  call void (%List*, %ListForeachHandler, %Unit*) @func64 (%List* %13, %ListForeachHandler @func497, %Unit* %15)
;stmt4:
...
;stmt5:
  %20 = bitcast %Stmt* %4 to %union.5
  ret %union.5 %20
}

define %union.5 @func498 (%AstStmt*) {
;stmt0:
...
;stmt4:
  ...
  %17 = load %TokenInfo*, %TokenInfo** %16
  %18 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 1, %TokenInfo* %17)
;stmt5:
...
;stmt6:
  %21 = bitcast %Stmt* %18 to %union.5
  ret %union.5 %21
}

define %union.5 @func499 (%AstStmt*) {
;stmt0:
...
;stmt1:
  ...
  %9 = call %union.5 (%AstStmt*) @func492 (%AstStmt* %8)
;stmt2:
  %10 = alloca %union.12
...
;stmt3:
  ...
  %15 = bitcast %Int64 0 to %Int64
  %16 = ptrtoint %union.0 %14 to %Int64
  %17 = icmp eq %Int64 %16, %15
  %18 = xor i1 %17, 1
  br i1 %18, label %then_0, label %else_0
then_0:
;stmt4:
  ...
  %23 = call %union.5 (%AstStmt*) @func492 (%AstStmt* %22)
;stmt5:
...
then_1:
;stmt6:
  %28 = bitcast %union.5 %23 to %Stmt*
  %29 = bitcast %Stmt* %28 to %union.12
  store %union.12 %29, %union.12* %10, align 16
  br label %endif_1
else_1:
  br label %endif_1
endif_1:
...
then_2:
;stmt8:
  %33 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %33
  br label %endif_2
else_2:
  br label %endif_2
...
then_3:
;stmt10:
  %42 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %42
  br label %endif_3
else_3:
  br label %endif_3
...
;stmt11:
  ...
  %45 = ptrtoint %union.5 %9 to %Int64
  %46 = icmp eq %Int64 %45, %44
  br i1 %46, label %then_4, label %else_4
then_4:
;stmt12:
  %47 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %47
  br label %endif_4
else_4:
  br label %endif_4
...
;stmt13:
  ...
  %51 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 5, %TokenInfo* %50)
;stmt14:
...
;stmt16:
  ...
  %59 = load %union.12, %union.12* %10
  store %union.12 %59, %union.12* %58, align 16
;stmt17:
  %60 = bitcast %Stmt* %51 to %union.5
  ret %union.5 %60
}

define %union.5 @func500 (%AstStmt*) {
;stmt0:
...
;stmt2:
  ...
  %15 = call %union.5 (%AstStmt*) @func492 (%AstStmt* %14)
;stmt3:
  %16 = load %FuncContext*, %FuncContext** @fctx
...
then_0:
;stmt5:
  %25 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %25
  br label %endif_0
else_0:
  br label %endif_0
...
then_1:
;stmt7:
  %34 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %34
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt8:
  ...
  %37 = ptrtoint %union.5 %15 to %Int64
  %38 = icmp eq %Int64 %37, %36
  br i1 %38, label %then_2, label %else_2
then_2:
;stmt9:
  %39 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %39
  br label %endif_2
else_2:
  br label %endif_2
...
;stmt10:
  ...
  %42 = load %TokenInfo*, %TokenInfo** %41
  %43 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 6, %TokenInfo* %42)
;stmt11:
...
;stmt12:
  ...
  %48 = bitcast %union.5 %15 to %Stmt*
  store %Stmt* %48, %Stmt** %47, align 8
;stmt13:
  %49 = bitcast %Stmt* %43 to %union.5
  ret %union.5 %49
}
...
define %union.5 @func501 (%AstStmt*) {
;stmt0:
...
;stmt6:
  ...
  %27 = load %TokenInfo*, %TokenInfo** %26
  %28 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 7, %TokenInfo* %27)
;stmt7:
...
;stmt8:
  %31 = bitcast %Stmt* %28 to %union.5
  ret %union.5 %31
}

define %union.5 @func503 (%AstStmt*) {
;stmt0:
  %2 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %2
}

define %union.5 @func504 (%AstStmt*) {
;stmt0:
...
;stmt7:
  %21 = inttoptr %Unit zeroinitializer to %union.5
  ret %union.5 %21
}

define %union.5 @func505 (%AstStmt*) {
;stmt0:
  %2 = load %FuncContext*, %FuncContext** @fctx
...
;stmt2:
  ...
  %9 = load %TokenInfo*, %TokenInfo** %8
  %10 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 8, %TokenInfo* %9)
  %11 = bitcast %Stmt* %10 to %union.5
  ret %union.5 %11
}

define %union.5 @func506 (%AstStmt*) {
;stmt0:
  %2 = load %FuncContext*, %FuncContext** @fctx
  %3 = getelementptr inbounds %FuncContext, %FuncContext* %2, i1 0, i32 3
  %4 = load %Nat32, %Nat32* %3
...
;stmt2:
  %8 = getelementptr inbounds %AstStmt, %AstStmt* %0, i1 0, i32 12
  %9 = load %TokenInfo*, %TokenInfo** %8
  %10 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 9, %TokenInfo* %9)
  %11 = bitcast %Stmt* %10 to %union.5
  ret %union.5 %11
}

define %union.5 @func507 (%AstStmt*) {
;stmt0:
  %2 = getelementptr inbounds %AstStmt, %AstStmt* %0, i1 0, i32 12
  %3 = load %TokenInfo*, %TokenInfo** %2
  %4 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 10, %TokenInfo* %3)
;stmt1:
...
;stmt2:
  %11 = bitcast %Stmt* %4 to %union.5
  ret %union.5 %11
}

define %union.5 @func508 (%AstStmt*) {
;stmt0:
  %2 = getelementptr inbounds %AstStmt, %AstStmt* %0, i1 0, i32 12
  %3 = load %TokenInfo*, %TokenInfo** %2
  %4 = call %Stmt* (%StmtKind, %TokenInfo*) @func490 (%StmtKind 11, %TokenInfo* %3)
;stmt1:
  %5 = getelementptr inbounds %Stmt, %Stmt* %4, i1 0, i32 7
