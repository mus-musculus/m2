...
;stmt3:
  call void (%Type*) @func365 (%Type* %5)
;stmt4:
  %9 = bitcast [2 x %Nat8]* @func279_func281_str2 to %Str
...
;stmt19:
  ...
  call void (%List*, %MapForeachHandler, %Unit*) @map_foreach (%List* %41, %MapForeachHandler @func281, %Unit* zeroinitializer)
;stmt20:
  call void () @nl ()
;stmt21:
