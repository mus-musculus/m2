...
@func352_str6 = private unnamed_addr constant [6 x i8] c"undef\00", align 1
@func352_str7 = private unnamed_addr constant [32 x i8] c"<LLVM_ValueInvalid x.kind = %d>\00", align 1
...
;stmt1:
  %4 = getelementptr inbounds %LLVM_Value, %LLVM_Value* %3, i1 0, i32 0
  store %LLVM_ValueKind 8, %LLVM_ValueKind* %4, align 2
;stmt2:
  %5 = getelementptr inbounds %LLVM_Value, %LLVM_Value* %3, i1 0, i32 1
  store %Type* %0, %Type** %5, align 8
;stmt3:
...
;stmt2:
  ...
  %9 = call %LLVM_Value (%LLVM_ValueKind, %Type*, %Int64) @llval_create (%LLVM_ValueKind 1, %Type* %8, %Int64 0)
...
select_1_5_ok:
  ...
  br label %select_1_end
select_1_6:
  %30 = icmp eq %LLVM_ValueKind %2, 1
  br i1 %30, label %select_1_6_ok, label %select_1_7
select_1_6_ok:
  %31 = load %FILE*, %FILE** @fout
  %32 = bitcast [6 x %Nat8]* @func352_str6 to %Str
  %33 = call %Int32 (%FILE*, %Str, ...) @fprintf (%FILE* %31, %Str %32)
  br label %select_1_end
select_1_7:
  %34 = load %FILE*, %FILE** @fout
  %35 = bitcast [32 x %Nat8]* @func352_str7 to %Str
  %36 = extractvalue %LLVM_Value %0, 0
  %37 = call %Int32 (%FILE*, %Str, ...) @fprintf (%FILE* %34, %Str %35, %LLVM_ValueKind %36)
  br label %select_1_end
select_1_end:
  %38 = phi %Int32 [ %4, %select_1_0_ok ], [ %9, %select_1_1_ok ], [ %14, %select_1_2_ok ], [ %19, %select_1_3_ok ], [ %24, %select_1_4_ok ], [ %29, %select_1_5_ok ], [ %33, %select_1_6_ok ], [ %37, %select_1_7 ]
  ret void
}
